...
var map = {
	"./pages/find-restaurant/find-restaurant.module": [
		"./src/app/pages/find-restaurant/find-restaurant.module.ts",
		"default~pages-find-restaurant-find-restaurant-module~pages-test-map-test-map-module",
		"common",
		"pages-find-restaurant-find-restaurant-module"
	],
	"./pages/historical/historical.module": [
		"./src/app/pages/historical/historical.module.ts",
		"default~pages-historical-historical-module~pages-list-wine-list-wine-module",
		"common",
		"pages-historical-historical-module"
	],
	...
	"./pages/list-millesime/list-millesime.module": [
		"./src/app/pages/list-millesime/list-millesime.module.ts",
		"pages-list-millesime-list-millesime-module"
	],
	"./pages/list-wine/list-wine.module": [
	...
	"./pages/test-map/test-map.module": [
...
module.exports = __webpack_require__(/*! C:\Users\Eddy\Dropbox\@HEGSemestre8\Travail-de-Bachelor\Ionic\VaudVin-front\src\main.ts */"./src/main.ts");
